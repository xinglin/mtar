/* Scan the input tar file and output valid header blocks and data blocks. 
   The current usage is to remove padded blocks at the end of a tar file.
   Since padded blocks are handled before it is handled to this module,
   we actually do not need to do anything.
...
/*  Set up to filter an archive.  */
void
filter_init (void)
{
  char filterfile[NAME_MAX];

/* Restore a migratory tar file into a regular tar file
...
static void copy_data(char input[NAME_MAX], int outputfd, unsigned long long blocks)
{
...
static int
restore_dir (char *filename, int typeflag)
{
  return 0;
}
...
/* Prepare to restore a file. Find restoration function.
   Return zero if extraction should not proceed.  */

static int
prepare_to_restore (char const *file_name, int typeflag, tar_extractor_t *fun)
{
  int rc = 1;
